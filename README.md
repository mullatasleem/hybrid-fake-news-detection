...
> This repository accompanies the paper. It contains the published paper (PDF + LaTeX source), all figures, and the results exactly as reported. The model training code is not included in this release.
